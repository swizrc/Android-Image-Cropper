...
public abstract class AbstractCropImageView extends FrameLayout {
...
// "The Art of War"
        ...
        protected final CropOverlayView mCropOverlayView;
        ...
        protected final Matrix mImageInverseMatrix = new Matrix();
        ...
        protected AbstractCropImageView.ScaleType mScaleType;
         ...
         */
        protected boolean mSaveBitmapToInstanceState = false;
         ...
         */
        protected boolean mShowCropOverlay = true;
         ...
         * set with bitmap
         */
        protected Uri mSaveInstanceStateBitmapUri;

        /** Task used to load bitmap async from UI thread */
        protected WeakReference<BitmapLoadingWorkerTask> mBitmapLoadingWorkerTask;

        /** Task used to crop bitmap async from UI thread */
        protected WeakReference<BitmapCroppingWorkerTask> mBitmapCroppingWorkerTask;
        // endregion

        public AbstractCropImageView(Context context) {
            this(context, null);
        }

        public AbstractCropImageView(Context context, AttributeSet attrs) {
            super(context, attrs);
            ...
            if (options == null) {
                ...
                if (attrs != null) {
                    ...
                    try {
                        ...
                        options.scaleType =
                                AbstractCropImageView.ScaleType.values()[
                        ...
                        options.cropShape =
                                AbstractCropImageView.CropShape.values()[
                                        ta.getInt(R.styleable.CropImageView_cropShape, options.cropShape.ordinal())];
                        options.guidelines =
                                AbstractCropImageView.Guidelines.values()[
                                        ta.getInt(
            ...
            mCropOverlayView.setCropWindowChangeListener(
                    new CropOverlayView.CropWindowChangeListener() {
                        ...
                        public void onCropWindowChanged(boolean inProgress) {
                            ...
                            AbstractCropImageView.OnSetCropOverlayReleasedListener listener = mOnCropOverlayReleasedListener;
                            if (listener != null && !inProgress) {
                                listener.onCropOverlayReleased(getCropRect());
                            }
                            AbstractCropImageView.OnSetCropOverlayMovedListener movedListener = mOnSetCropOverlayMovedListener;
        ...
        public AbstractCropImageView.ScaleType getScaleType() {
            return mScaleType;
        }

        /** Set the scale type of the image in the crop view */
        public void setScaleType(AbstractCropImageView.ScaleType scaleType) {
        ...
        public AbstractCropImageView.CropShape getCropShape() {
         ...
         */
        public void setCropShape(AbstractCropImageView.CropShape cropShape) {
        ...
        public AbstractCropImageView.Guidelines getGuidelines() {
         ...
         * application.
         */
        public void setGuidelines(AbstractCropImageView.Guidelines guidelines) {
        ...
        public Bitmap getCroppedImage() {
            return getCroppedImage(0, 0, AbstractCropImageView.RequestSizeOptions.NONE);
        }

        /**
         * Gets the cropped image based on the current crop window.<br>
         * Uses {@link AbstractCropImageView.RequestSizeOptions#RESIZE_INSIDE} option.
         *
        ...
        public Bitmap getCroppedImage(int reqWidth, int reqHeight) {
            return getCroppedImage(reqWidth, reqHeight, AbstractCropImageView.RequestSizeOptions.RESIZE_INSIDE);
        }
         ...
         * @return a new Bitmap representing the cropped image
         */
        public Bitmap getCroppedImage(int reqWidth, int reqHeight, AbstractCropImageView.RequestSizeOptions options) {
            Bitmap croppedBitmap = null;
            if (mBitmap != null) {
                mImageView.clearAnimation();

                reqWidth = options != AbstractCropImageView.RequestSizeOptions.NONE ? reqWidth : 0;
                reqHeight = options != AbstractCropImageView.RequestSizeOptions.NONE ? reqHeight : 0;

                if (mLoadedImageUri != null
                        && (mLoadedSampleSize > 1 || options == AbstractCropImageView.RequestSizeOptions.SAMPLING)) {
         ...
         * #setOnCropImageCompleteListener(AbstractCropImageView.OnCropImageCompleteListener)}.
         */
        public void getCroppedImageAsync() {
            getCroppedImageAsync(0, 0, AbstractCropImageView.RequestSizeOptions.NONE);
        }

        /**
         * Gets the cropped image based on the current crop window.<br>
         * Uses {@link AbstractCropImageView.RequestSizeOptions#RESIZE_INSIDE} option.<br>
         * The result will be invoked to listener set by {@link
         * #setOnCropImageCompleteListener(AbstractCropImageView.OnCropImageCompleteListener)}.
         *
         * @param reqWidth the width to resize the cropped image to
        ...
        public void getCroppedImageAsync(int reqWidth, int reqHeight) {
            getCroppedImageAsync(reqWidth, reqHeight, AbstractCropImageView.RequestSizeOptions.RESIZE_INSIDE);
        }
         ...
         * @param options the resize method to use, see its documentation
         */
        public void getCroppedImageAsync(int reqWidth, int reqHeight, AbstractCropImageView.RequestSizeOptions options) {
        ...
        public void saveCroppedImageAsync(Uri saveUri) {
            saveCroppedImageAsync(saveUri, Bitmap.CompressFormat.JPEG, 90, 0, 0, AbstractCropImageView.RequestSizeOptions.NONE);
        }
        ...
        public void saveCroppedImageAsync(
            ...
            saveCroppedImageAsync(
                    saveUri, saveCompressFormat, saveCompressQuality, 0, 0, AbstractCropImageView.RequestSizeOptions.NONE);
        }
        ...
        public void saveCroppedImageAsync(
            ...
            saveCroppedImageAsync(
                    ...
                    reqWidth,
                    reqHeight,
                    AbstractCropImageView.RequestSizeOptions.RESIZE_INSIDE);
        }
        ...
        /** Set the callback t */
        public void setOnSetCropOverlayReleasedListener(AbstractCropImageView.OnSetCropOverlayReleasedListener listener) {
            mOnCropOverlayReleasedListener = listener;
        }

        /** Set the callback when the cropping is moved */
        public void setOnSetCropOverlayMovedListener(AbstractCropImageView.OnSetCropOverlayMovedListener listener) {
            mOnSetCropOverlayMovedListener = listener;
        }

        /** Set the callback when the crop window is changed */
        public void setOnCropWindowChangedListener(AbstractCropImageView.OnSetCropWindowChangeListener listener) {
         ...
         */
        public void setOnSetImageUriCompleteListener(AbstractCropImageView.OnSetImageUriCompleteListener listener) {
         ...
         */
        public void setOnCropImageCompleteListener(AbstractCropImageView.OnCropImageCompleteListener listener) {
         ...
         */
        protected void onSetImageUriAsyncComplete(BitmapLoadingWorkerTask.Result result) {
            ...
            AbstractCropImageView.OnSetImageUriCompleteListener listener = mOnSetImageUriCompleteListener;
            if (listener != null) {
         ...
         */
        protected void onImageCroppingAsyncComplete(BitmapCroppingWorkerTask.Result result) {
            ...
            if (listener != null) {
                AbstractCropImageView.CropResult cropResult =
                        new AbstractCropImageView.CropResult(
                                mBitmap,
                                mLoadedImageUri,
                                result.bitmap,
                                result.uri,
        ...
        public void onRestoreInstanceState(Parcelable state) {
            ...
            if (state instanceof Bundle) {
                ...
                if (mBitmapLoadingWorkerTask == null
                    ...
                    mCropOverlayView.setCropShape(AbstractCropImageView.CropShape.valueOf(bundle.getString("CROP_SHAPE")));
        ...
        protected void applyImageMatrix(float width, float height, boolean center, boolean animate) {
            if (mBitmap != null && width > 0 && height > 0) {
                ...
                if (mScaleType == AbstractCropImageView.ScaleType.FIT_CENTER
                        || (mScaleType == AbstractCropImageView.ScaleType.CENTER_INSIDE && scale < 1)
         ...
         */
        protected static int getOnMeasureSpec(int measureSpecMode, int measureSpecSize, int desiredSize) {
        ...
        public interface OnSetImageUriCompleteListener {
             ...
             */
            void onSetImageUriComplete(AbstractCropImageView view, Uri uri, Exception error);
        }
        // endregion
        ...
        public interface OnCropImageCompleteListener {
             ...
             */
            void onCropImageComplete(AbstractCropImageView view, AbstractCropImageView.CropResult result);
        }
        // endregion
